...
function gotNewSettings(settings, slength) {
    ...
    if (((version === 10/*old*/ && len === 45 + 6/*maxNumDriveButtons*/) || (version === 11/*standard*/ && len == 47 + 6) || (version === 13/*with wifi*/ && len == 50 + 6) || (version == 14/*pcb*/ && len == 46 + 6) || (version == 15/*pcb with wifi*/ && len == 49 + 6)|| (version == 16/*RC*/ && len == 48 + 6)) && slength === settings["CHECKSUM"]) {
        ...
        for (const setting in settings) {
            ...
            if (Array("SCALE_ACCEL_WITH_SPEED", "REVERSE_TURN_IN_REVERSE", "USE_SPEED_KNOB", "ENABLE_STARTUP_PULSE", "ENABLE_BUTTON_CTRL", "USE_BUTTON_MODE_PIN", "STEERING_OFF_SWITCH", "USE_WIFI", "SWAP_MOTORS").indexOf(setting) > -1) { //boolean checkbox
